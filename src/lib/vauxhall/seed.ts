...
export const SEED_EVENTS: AgentEvent[] = [
  ...
  },
  {
    ...
    agent: "Moneypenny",
    type: "Knowledge",
    summary: "Canon version v41 published: No. 3 Peak batch note revision",
  ...
  },
  {
    ...
    agent: "Q",
    type: "Insight",
    summary: "Reorder rate for No. 1 Dialed trending up 12 percent week over week",
...
export const EVENT_POOL: Omit<AgentEvent, "id" | "time" | "audit">[] = [
  ...
  },
  {
    agent: "Q",
    type: "Trend",
    summary: "Reorder signal steady on No. 2 Unwind",
    sub: "Within plan, no action needed",
  },
];
